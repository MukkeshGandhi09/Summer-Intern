...
class CarlaGame(object):
    ...
    def _on_loop(self):
        ...
        if((COUNT%frame)==0):
            location=[measurements.player_measurements.transform.location.x,measurements.player_measurements.transform.location.y,measurements.player_measurements.transform.location.z]
            rotation=[measurements.player_measurements.transform.rotation.pitch,measurements.player_measurements.transform.rotation.yaw,measurements.player_measurements.transform.rotation.roll]
            row=[COUNT,location,rotation]
            with open("E:\Location and Orientation.csv",'a', newline='') as f:
        	    writer=csv.writer(f)
        	    writer.writerow(row)
        ...
        if self._timer.elapsed_seconds_since_lap() > 1.0:
            if self._city_name is not None:
                ...
                lane_orientation = self._map.get_lane_orientation([
                    ...
                    measurements.player_measurements.transform.location.y,
                    measurements.player_measurements.transform.location.z])
                #print("Position: "+format(map_position))
                #print("Orientation: "+format(lane_orientation))
                ...
                print("else executed"+format(COUNT))
